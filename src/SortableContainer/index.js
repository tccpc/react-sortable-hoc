  ...
  return class WithSortableContainer extends React.Component {
    ...
    animateNodes() {
      ...
      for (let i = 0, len = nodes.length; i < len; i++) {
        ...
        const offset = {
          height:
            this.height > height ? height / 2 : this.height * onSortOffset,
          width: this.width > width ? width / 2 : this.width * onSortOffset,
        };
        ...
        if (this.axis.x) {
          if (this.axis.y) {
            if (onSortHover && onSortOffset <= 0.5) {
              if (
                (index < this.index &&
                  ((sortingOffset.top + windowScrollDelta.top >=
                    ...
                    sortingOffset.left + windowScrollDelta.left <=
                      edgeOffset.left + this.width - offset.width &&
                    sortingOffset.left + windowScrollDelta.left >=
                      edgeOffset.left + offset.width) ||
                    (sortingOffset.top + windowScrollDelta.top <=
                      edgeOffset.top + this.height - offset.height &&
                      sortingOffset.top + windowScrollDelta.top >=
                        edgeOffset.top + offset.height &&
                      sortingOffset.left + windowScrollDelta.left <=
                        edgeOffset.left + offset.width &&
                ...
                (index > this.index &&
                  ((sortingOffset.top + windowScrollDelta.top >=
                    ...
                    sortingOffset.top + windowScrollDelta.top <=
                      edgeOffset.top + offset.height &&
                    sortingOffset.left + windowScrollDelta.left + this.width >=
                      edgeOffset.left + offset.width &&
                    sortingOffset.left + windowScrollDelta.left <=
                      edgeOffset.left - offset.width) ||
                    (sortingOffset.top + windowScrollDelta.top <=
                      edgeOffset.top - offset.height &&
                      sortingOffset.top + windowScrollDelta.top + this.height >=
                        edgeOffset.top + offset.height &&
                      sortingOffset.left + windowScrollDelta.left <=
                        edgeOffset.left + offset.width &&
                      sortingOffset.left + windowScrollDelta.left >=
      ...
      if (onSortHover) {
        onSortHover(this.hoverIndex, this.index);
      }
